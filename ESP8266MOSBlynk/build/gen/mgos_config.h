 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/2.10.2/apps/ESP8266MOSBlynk/esp8266/build_contexts/build_ctx_789929979/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /fwbuild-volumes/2.10.2/apps/ESP8266MOSBlynk/esp8266/build_contexts/build_ctx_789929979/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_config_blynk *mgos_config_get_blynk(struct mgos_config *cfg);
int         mgos_config_get_blynk_enable(struct mgos_config *cfg);
const char *mgos_config_get_blynk_server(struct mgos_config *cfg);
const char *mgos_config_get_blynk_auth(struct mgos_config *cfg);
...
void mgos_config_set_blynk_enable(struct mgos_config *cfg, int         val);
void mgos_config_set_blynk_server(struct mgos_config *cfg, const char *val);
void mgos_config_set_blynk_auth(struct mgos_config *cfg, const char *val);
...
static inline void mgos_sys_config_set_blynk_enable(int         val) { mgos_config_set_blynk_enable(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_blynk_server(const char *val) { mgos_config_set_blynk_server(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_blynk_auth(const char *val) { mgos_config_set_blynk_auth(&mgos_sys_config, val); }
